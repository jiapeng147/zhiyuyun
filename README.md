...
**一套面向平台卖家的自动化运营管理后台 — 账号、商品、订单、消息、自动发货、卡密、AI 自动回复，一站搞定。**
...
一套面向平台卖家的自动化运营后台，覆盖账号、商品、订单、消息、自动发货、卡密、AI 自动回复等核心场景，并支持多用户租户隔离。开箱即用，支持 Docker Compose 一键部署，也支持本地裸机开发。
