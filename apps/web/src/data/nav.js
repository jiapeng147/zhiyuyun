export const navGroups = [
  ...
  },
  {
    title: '系统',
    items: [
      { key: 'billing', label: '套餐账单', icon: 'record' },
...
export const pageTitles = {
  ...
  'admin-users': ['用户管理', '管理注册用户、套餐与自助注册开关（仅平台负责人）'],
  accounts: ['闲鱼账号', '管理账号状态、登录情况与连接状态'],
  connections: ['连接管理', '统一查看账号实时连接与登录凭证状态'],
  ...
  feedback: ['反馈建议', '提交产品建议、问题反馈与功能诉求'],
  'ad-application': ['广告申请', '查看真实商业套餐；未配置时提交与支付保持禁用'],
  billing: ['套餐账单', '查看当前套餐、配额用量与订阅订单'],
  'settings-ai-cs': ['系统设置 / AI 客服配置', '管理 AI 客服的人设、知识库、聊天规则与回复验证'],
